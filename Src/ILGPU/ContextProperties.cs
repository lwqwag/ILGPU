...
namespace ILGPU
{
    ...
    public enum DebugSymbolsMode
    {
        ...
        /// <summary>
        /// Debug information loaded form portable PDBs to enhance error messages
    ...
    public enum MathMode
    {
        ...
        /// <summary>
        /// Use fast math functions that all less precise.
        /// </summary>
        Fast,
    ...
    public class ContextProperties
    {
        ...
        public bool EnableAssertions { get; protected set; } = false;

        /// <summary>
        /// Returns true if additional kernel information is enabled.
        /// </summary>
        /// <remarks>Disabled by default.</remarks>
        public bool EnableKernelInformation { get; protected set; } = false;

        /// <summary>
        /// Returns true if the internal IR verifier is enabled.
        /// </summary>
        /// <remarks>Disabled by default.</remarks>
        public bool EnableVerifier { get; protected set; } = false;
