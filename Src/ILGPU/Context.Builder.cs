...
namespace ILGPU
{
    partial class Context
    {
        ...
        public sealed class Builder : ContextProperties
        {
            ...
            /// </summary>
            public DeviceRegistry AcceleratorRegistry { get; } =
                new DeviceRegistry();
            ...
            /// </summary>
            /// <param name="debugSymbolsMode"></param>
            /// <returns></returns>
            public Builder DebugSymbols(DebugSymbolsMode debugSymbolsMode)
            {
                DebugSymbolsMode = (DebugSymbolsMode)System.Math.Max(
                    (int)DebugSymbolsMode,
                    (int)debugSymbolsMode);
                return this;
            }
            ...
            public Context ToContext() => new Context(
                this,
                AcceleratorRegistry.ToImmutable());
        ...
        /// </summary>
        /// <param name="buildingCallback"></param>
        /// <returns></returns>
