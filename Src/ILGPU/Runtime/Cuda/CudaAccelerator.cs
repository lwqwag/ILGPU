...
namespace ILGPU.Runtime.Cuda
{
        ...
        KernelAccelerator<PTXCompiledKernel, CudaKernel>
    {
        ...
        public static bool TryGetInstructionSet(
            ...
            out PTXInstructionSet instructionSet)
        {
        ...
        /// </summary>
        public PTXArchitecture Architecture =>
            (PTXArchitecture)Device.Architecture;

        /// <summary>
        /// Returns the PTX instruction set.
        /// </summary>
        public PTXInstructionSet InstructionSet =>
            (PTXInstructionSet)Device.InstructionSet;
        ...
        /// </summary>
        public string GetNVMLPCIBusId() => Device.GetNVMLPCIBusId();
